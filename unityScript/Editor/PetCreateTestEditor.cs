...
[CustomEditor(typeof(PetCreateTest))] 
public class PetCreateTestEditor : Editor //Monobehaviour 대신 Editor를 넣습니다.
{
    ...
    public override void OnInspectorGUI()
    {
       ...
       //ItemEffectTrigger.cs 의 객체를 받아옵니다 => 이래야 버튼시 명령을 내릴수 잇습니다
        PetCreateTest petCreateTest= (PetCreateTest)target;
