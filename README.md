...
![Group_89__1_](./exec/img/Group_89__1_.png)
...
![write_diary](./exec/img/write_diary.gif)
...
![purchase](./exec/img/purchase.gif)

- 포인트를 사용하여 가구를 구매할 수 있습니다. 이미 구매한 가구는 구매한 표시가 되고 구매 불가합니다.

![search_furniture](./exec/img/search_furniture.gif)
...
![move_room](./exec/img/move_room.gif)

- WEB의 방 이동을 통해 여러 방을 변경할 수 있습니다.

![edit_room_info](./exec/img/edit_room_info.gif)

- default 방 설정을 하여 자동으로 들어가는 방을 정할 수 있고 방 정보 버튼을 눌러 정보 수정이 가능합니다.

### 방 꾸미기

![interior](./exec/img/interior.gif)
...
![re_interior](./exec/img/re_interior.gif)

- 이미 배치한 물건들도 인테리어 모드를 통해 위치를 수정하거나 제거할 수 있습니다.

### 음악

![music](./exec/img/music.gif)
...
![Untitled](./exec/img/Untitled.png)
![Untitled_1](./exec/img/Untitled_1.png)
...
![_EC_A0_9C_EB_AA_A9__EC_97_86_EB_8A_94__EB_8B_A4_EC_9D_B4_EC_96_B4_EA_B7_B8_EB_9E_A8.drawio__2_](./exec/img/_EC_A0_9C_EB_AA_A9__EC_97_86_EB_8A_94__EB_8B_A4_EC_9D_B4_EC_96_B4_EA_B7_B8_EB_9E_A8.drawio__2_.png)

### 폴더 구조

![file](./exec/img/file.png)
...
![Untitled_2](./exec/img/Untitled_2.png)
...
![_ED_8C_80_EC_9B_90_EC_86_8C_EA_B0_9C](./exec/img/_ED_8C_80_EC_9B_90_EC_86_8C_EA_B0_9C.png)
